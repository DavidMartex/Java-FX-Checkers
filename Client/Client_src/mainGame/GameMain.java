...
public class GameMain extends Application {
	...
	private byte[][] valid_to = new byte[10][10];
	private byte selectedRow, selectedCol;
	private Image[] checker_images = new Image[10];
	private final Image white_piece = new Image ("image_resources/chips_white.png", GRID_DIMENSION, GRID_DIMENSION, true, true, true);
	private final Image black_piece = new Image ("image_resources/chips_black.png", GRID_DIMENSION, GRID_DIMENSION, true, true, true);
	private final Image white_king = new Image ("image_resources/chips_white_king.png", GRID_DIMENSION, GRID_DIMENSION, true, true, true);
	private final Image black_king = new Image ("image_resources/chips_black_king.png", GRID_DIMENSION, GRID_DIMENSION, true, true, true);
	private final Image bg_black = new Image ("image_resources/bg_black.png", GRID_DIMENSION, GRID_DIMENSION, false, true, true);
	private final Image bg_white = new Image ("image_resources/bg_white.png", GRID_DIMENSION, GRID_DIMENSION, false, true, true);
	...
	private boolean set_valids (byte row, byte col) {
		byte strt = 0, nd = 2, stt = state[row][col];//start and end by default (for white)
...
//					finish ();
	...
	public void start (Stage primaryStage) throws Exception {
		...
		game_window.getIcons ().add (new Image ("image_resources/icon.png"));
